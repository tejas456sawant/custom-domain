...
def add_https_domain_with_tls(domain, upstream, tls_config, port=HTTPS_PORT, template=None, replace=True, disable_https=False):
...
def route_template_with_tls(domain, upstream, tls_config, disable_https=False):
